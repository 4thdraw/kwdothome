	 ...
	 <div class='subMn border-bottom py-5'>
			<div class="max-width mx-auto px-3 px-xl-0 d-flex w-100 justify-content-between align-items-center pt-5">
				...
				<div class='kw_gallery_searchdom'>
					<form name="frmSearch" id="frmSearch" action="<?php echo $_SERVER['PHP_SELF']?>" method="GET" onSubmit="return searchForm();">
							설치장소 : 
							<select name="place" id="place" size="1" style="width: 180px; height: 20px; color: #999; border: 1px solid #DDD; vertical-align: middle;" onChange="searchForm()">
							...
							분류 : 
							<select name="skey1" id="skey1" size="1" style="width: 120px; height: 20px; color: #999; border: 1px solid #DDD; vertical-align: middle;" onChange="searchForm()">
							...
							<input type="text" name="sbval" id="sbval" maxlength="50" value="<?php echo $tmp_sbval?>" style="width:130px;vertical-align:middle"/>
							<input type="image" src="../img/btn/search.gif" style="border:none;cursor:pointer;width:71px;height:24px;vertical-align:middle" align="absbottom" />
					</form>
			  	</div>
