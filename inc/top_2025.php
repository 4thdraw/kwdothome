			...
			<div class="menu">
				...
				py-2 py-xl-1 bg-white px-3 px-xl-0 gnb_dom'>
					...
					<ul class="mx-auto max-width py-2 navilist fw600 fs-18 d-flex justify-content-between align-items-center">
						...
						<li class="navili d-none d-xl-block"><a href="<?php echo $kw_url; ?>/page/place_list.php?skey1=001&skey2=001001">공간별추천</a></li>
				...
				<?php if(defined('_PROLIST_')){ 
					// 제품페이지일때 노출
					include_once($kw_path."/inc/prolist_navi.php");
				} ?>
