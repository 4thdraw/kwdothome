...
<?php
defined('_FC_') ? include_once($kw_path."/inc/footer_custom.php") : null;
?>
<!--하단 -->
</div>
<footer id="ft">
    ...
    <div class="max-width mx-auto footer-info d-lg-flex gap-5  py-lg-5 py-4 px-3 px-xl-0">
        <div class="logo d-flex  d-lg-block align-items-center justify-content-between">
            <?php include($kw_path."/img/2025/logo/mainlogo.html"); ?>

            <div class="certification d-flex justify-content-between align-items-center gap-2 gap-sm-1  d-lg-none">
                <img src="<?php echo $kw_url.'/img/2025/mark/brand005.png'; ?>" class='ssl' alt="Alpha SSL 인증마크">
                <img src="<?php echo $kw_url.'/img/2025/mark/img_escrow_mark2.jpg'; ?>" class='kb' alt="에스크로 인증마크">
                <img src="<?php echo $kw_url.'/img/2025/mark/ct_logo.jpg'; ?>" class='ct' alt="개인정보보호 인증마크">
            </div>
        </div>
        <div class="company-details fs-15 d-flex flex-column justify-content-center  mt-4 mt-lg-0 keep-all">
            <div class='d-sm-flex flex-wrap gap-lg-3 gap-2 mt-2'>
                <p><strong>주소</strong> 인천광역시 남동구 호구포로 194, 2층 227호(고잔동, 더마크원) </p>
                <p><strong>TEL</strong> 1661-8849</p> 
                <p><strong>FAX</strong> 032-811-9011</p>
                <p><strong>E-Mail</strong> ghm6029@hanmail.net</p>
            </div>           
            <div class='d-sm-flex flex-wrap gap-3 mt-1'>
                <p><strong>상호명</strong> 강화카페트매트</p>
                <p><strong>대표</strong> 안상녀</p> 
                <p><strong>사업자등록번호</strong> 131-26-99277 <button type="button" class='border bg-white py-1 px-2 fs-13 border-gray ms-sm-3'>사업자정보 조회하기</button></p>
